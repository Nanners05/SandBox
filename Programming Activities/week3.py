...
live = int(input("What age would you like to live to? >"))

print(f"You have {live - age} years to live!")
...
Write an if statement that checks to see if their score is equal to or greater than 93.  If so, print "Congratulations you got an A" else print "Congratulations, you still learned a ton!!!!"
"""
